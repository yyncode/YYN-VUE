<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="分类图片" align="center" prop="imageUrl" >
...
<!--          <el-input v-model="form.imageId" placeholder="请输入分类图片" />-->
        ...
        <el-form-item label="排序方式" prop="sort">
          <el-input-number v-model="form.sort" placeholder="请输入排序方式" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
          <el-radio-group v-model="form.status">
            <el-radio
              v-for="dict in dict.type.goods_category_status"
              :key="dict.value"
...
<script>
import {addCategory, delCategory, getCategory, listCategory, updateCategory} from "@/api/goods/category";
